...
namespace Microsoft.ML.Transforms
{
    ...
    /// </summary>
    /// <remarks>
///     <h3>Estimator Characteristics</h3>
/// <list type="table">
///   <item>
///     <term>Does this estimator need to look at the data to train its parameters?</term>
///     <term>No</term>
///   </item>
///   <item>
///     <term>Input column data type</term>
///     <term>float, double, int, long, bool or text.</term>
///   </item>
///   <item>
///     <term>Output column data type</term>
///     <term>Can be float, double, int, long, bool or text, depending on the expression.</term>
///   </item>
/// </list>
/// <para>The resulting <see cref="ExpressionTransformer"/> creates a new column,
/// named as specified in the output column name parameters, where the expression is applied
/// to the input values. At most one of the input columns can be of type
/// <see cref="VectorDataViewType"/>, and when the input contains a vector column, the expression
/// is computed independently on each element of the vector, to create a vector output with the
/// same length as that input.</para>
